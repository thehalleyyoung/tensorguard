...
\texttt{vmap} batched-dimension transfers, and library-specific contracts before
...
and \texttt{vmap} batched-dimension transfer.  A typical workflow is:
...
Six high-value library checkers demonstrate the pattern for precision without
unsoundness:
...
\begin{itemize}[leftmargin=2em]
  \item deeper operator coverage for sparse tensors, grid sampling, MultiheadAttention,
