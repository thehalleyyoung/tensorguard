...
and library-specific contracts before
...
\texttt{vmap} batched-dimension transfer, and sparse tensor layouts.  A typical
workflow is:
...
\begin{itemize}[leftmargin=2em]
  \item deeper operator coverage for grid sampling, MultiheadAttention,
...
export, einops, SDPA, distribution, complex FFT/view, named-axis, vmap, and
sparse-layout hazards
