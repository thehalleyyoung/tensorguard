...
(\Cref{tab:handler-soundness}, 36 operators including \textsc{T-Linear},
...
\textsc{T-Squeeze}, \textsc{T-Unsqueeze},
\textsc{T-Argmax}, \textsc{T-CrossEntropy}, \textsc{T-Dropout},
\textsc{T-Contiguous}, \textsc{T-Clamp}, \textsc{T-To}).
