...
produces a uniquely-typed result. The $36$ Lean-audited handlers
(Table~\ref{tab:handler-soundness}, top block) are sorry-free at
the rule definitions; the $13$ pen-and-paper handlers follow from
...
table it implements;
(e)~coverage of the $34$ tested-only handlers
