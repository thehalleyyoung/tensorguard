...
\texttt{mobilenet\_v3\_small} & torchvision & trusted  & 1/32 & 3/3 \\
...
dimensions (\texttt{out\_size = (in\_size + 2*pad - k)//stride + 1} and
...
violation we tried fired a Dynamo guard or a runtime check (the lone
...
seeds are in \texttt{experiments\_v5/dynamo\_correspondence\_v5.json}.
