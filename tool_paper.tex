...
tensor-parallel attention variants, and deployment schemas.
...
DDP/FSDP/FSDP2/DTensor/per-parameter and tensor-parallel checks, plus
...
FSDP, DeepSpeed, FSDP2, DTensor, per-parameter, and tensor-parallel
