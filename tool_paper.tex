...
ONNX shape-inference disagreements, mixed-precision/autocast dtype drift, and
distributed sharding mistakes.
...
gates, including GGUF/llama.cpp checkpoint preflight checks for transformer
metadata and projection tensors. \\
\hline
