...
compatibility, and deployment schemas.
...
\hline
Export gates &
Export, ONNX, AOTInductor, GGUF, quantization, and mixed-precision paths check static
...
before \texttt{optimizer.load\_state\_dict}. &
ONNX, AOT, GGUF, quantization, mixed-precision, and guarded compile/export
tests. \\
\hline
