...
\texttt{tests/test\_model\_zoo\_certification.py}.  Regenerates static result
views for reviewers and contributors, including the signed public leaderboard,
monthly freshness cadence, SSH trust anchor, anti-overfitting intake rules, and
status-badged gallery certification jobs. \\
\hline
Statistical rigor &
...
synthetic, natural, stress, and real-bug evidence separate.  For artifact review,
...
tamper-evident SHA-256 generated-output hashes. \\
\hline
\end{longtable}
