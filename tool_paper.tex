...
plus explicit pipeline activation-boundary contracts. \\
\hline
...
FSDP, DeepSpeed, FSDP2, DTensor, per-parameter, pipeline-boundary, and tensor-parallel
shape/device contracts, including rank-specific shard-shape conformance against
PyTorch's \texttt{torch.distributed.tensor} placement helper. \\
\hline
...
Sharding, explicit pipeline stage boundaries, tensor parallelism, optimizer
state, checkpoints, and LoRA adapters have shape/dtype/rank contracts layered
over base verification. &
