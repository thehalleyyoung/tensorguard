...
post-export ONNX shape-inference agreement.  GGUF/llama.cpp export gates check
...
writes an artifact.  The GGUF gate checks architecture-prefixed llama.cpp
...
ONNX, AOT, GGUF, CUDA graph, serving-schema, quantization, mixed-precision, and guarded compile/export
tests. \\
\hline
...
layouts, dtype/device policies, preserved dynamic guards and package-lowering
