...
and distributed sharding mistakes.
...
Deployment-facing gates for export, opsets, AOT packaging, and source/eager/FX
quantization. \\
\hline
...
availability, AOTInductor input layouts, quantization observer calibration,
