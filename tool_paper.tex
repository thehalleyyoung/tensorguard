...
registered transfer functions to an evidence tier: explicit Lean theorem,
pen-and-paper rule, tested-only rule, or heuristic.  In the current artifact the
manifest records 16 Lean-backed operator rows, 102 pen-and-paper static rules,
18 tested-only library contracts, and 3 honest heuristics.  Lean rows name the
...
operators, confidence tags, evidence tiers, release gates, and
...
generated from code and pinned against committed JSON.  The dashboard is
