...
weights whose aliases disagree, LoRA adapter matrix compatibility,
tensor-parallel shard coverage, and dtype drift that PyTorch would otherwise
silently cast.  Optimizer-state checks cover AdamW and fused-AdamW moment
...
checkpoint gates check missing/unexpected keys, tied weights, LoRA adapters,
tensor-parallel shards, and silent dtype drift; optimizer-state gates check
...
shape/dtype/rank contracts layered over base verification. &
