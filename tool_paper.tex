...
FFT/complex view contracts, exact \texttt{torch.linalg} contracts for
\texttt{solve}, inverse, Cholesky, SVD, eigendecomposition, and QR, named tensor
alignment, vmap/functorch batch dimensions, distribution batch/event/log-prob
shapes, grid sampling, affine grids, multi-head attention, scaled dot-product
attention, exact RNN/LSTM/GRU output and returned-state contracts, LoRA adapter
compatibility, training-loop checks, quantization/export safety, distributed
sharding, tensor parallel attention variants, and deployment schemas.
