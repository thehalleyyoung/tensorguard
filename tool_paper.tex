...
shape-inference round trips, and artifact scripts that regenerate
...
schemas.  The ONNX path validates structural checker and opset contracts, then
...
gates, including GGUF/llama.cpp checkpoint preflight checks and FSDP2/DTensor
...
and metadata consistency before an external converter is invoked. \\
\hline
...
state\_dict tensors and logical quantized descriptors. \\
\hline
...
before the converter writes a checkpoint. &
...
tests, including real PyTorch sharded attention and HuggingFace
