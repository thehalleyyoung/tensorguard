...
optimizer-state resume gates, and artifact scripts that regenerate
...
framework hooks, and deployment request/response schemas.  The ONNX path validates structural checker and opset contracts, then
...
compatibility, and TorchServe/FastAPI serving schemas.
...
\texttt{src/lora\_verification.py} &
...
\hline
Export gates &
Export, ONNX, AOTInductor, GGUF, serving, quantization, and mixed-precision paths check static
...
FastAPI/TorchServe-style wrappers. &
ONNX, AOT, GGUF, serving-schema, quantization, mixed-precision, and guarded compile/export
tests. \\
\hline
...
\hline
Export/serving precondition & ONNX, AOT, quantization, serving, or accelerator-specific
