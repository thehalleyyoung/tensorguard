...
audit Lean files.  They can also inspect the signed-certificate checker as a
small trusted component: it imports only the Python standard library, verifies
the canonical MAC and drift hashes, and independently replays the proof-DAG
shape that the main TensorGuard replay path accepts.  This is a different
posture from a one-off prototype: the paper claims are connected to code paths,
tests, and artifacts, and unsupported regions are part of the documented result.
