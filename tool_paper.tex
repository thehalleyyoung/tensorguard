...
divergences, gradient detach bugs, invalid sparse compressed layouts and
...
recurrent modules, fold/unfold, padding, grid sampling, sparse layouts and
sparse operators, complex
