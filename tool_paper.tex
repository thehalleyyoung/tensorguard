...
composition, and operator-specific rules such as cat, reshape, and einops
decomposition/bijection families.
...
batch-first layout, grouped head variants, MQA/GQA tensor-parallel partitioning,
KV-head replication, and sequence-parallel LayerNorm safety. \\
\hline
Embedding bags &
...
MHA and SDPA tests against real PyTorch modules and functional calls, plus
