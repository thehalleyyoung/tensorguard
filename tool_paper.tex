...
verifier.  The tutorial surface is generated the same way: ten Colab-runnable
notebooks are grouped into seven tracks---shapes, attention, export,
...
\texttt{tests/test\_leaderboard\_submission.py}.  Regenerates static result
views for reviewers and contributors, including the signed public leaderboard,
monthly freshness cadence, SSH trust anchor, and anti-overfitting intake rules. \\
\hline
Statistical rigor &
...
anti-overfitting rules.  The next natural milestones are larger blind real-bug
corpora, broader deployment galleries, and independently checkable certificates.
