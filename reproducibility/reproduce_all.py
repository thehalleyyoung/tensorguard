...
GENERATED_DETERMINISTIC = [
    ...
    "reproducibility/symbolic_shape_benchmark.json",
    "reproducibility/symbolic_shape_benchmark.md",
    ...
    "reproducibility/release_readiness.json",
    "reproducibility/release_readiness.md",
    "docs/contributing/operator_onboarding.md",
    "docs/contributing/good_first_operators.json",
    "docs/contributing/good_first_operators.md",
    "docs/contributing/operator_template.py",
    "docs/contributing/stub_authoring_guide.md",
    "docs/contributing/lean_proof_examples.md",
    "reproducibility/contributor_onboarding_audit.json",
    "reproducibility/contributor_onboarding_audit.md",
    ...
    "reproducibility/launch_dry_run.json",
    "reproducibility/launch_dry_run.md",
    "docs/launch/quickstart_terminal_demo.gif",
    "reproducibility/terminal_demo_gif.json",
    "reproducibility/terminal_demo_gif.md",
    "docs/launch/editor_lsp_demo.gif",
    "reproducibility/editor_lsp_demo_gif.json",
    "reproducibility/editor_lsp_demo_gif.md",
...
STEPS = [
    ...
    ("symbolic shapes: 100 module verifications without concrete input examples",
     [PY, "reproducibility/symbolic_shape_benchmark.py"], None),
    ...
    ("release: Step 286 PyPI/conda/Docker release-readiness gate",
     [PY, "reproducibility/release_readiness.py"], None),
    ("contributors: Step 287 good-first operator onboarding",
     [PY, "reproducibility/contributor_onboarding.py"], None),
    ("launch: Step 288 public 1.0-readiness campaign",
     [PY, "reproducibility/launch_campaign.py"], None),
    ("launch: Step 289 fresh-environment demo dry-run",
     [PY, "reproducibility/launch_dry_run.py"], None),
    ("launch: Step 290 quickstart terminal demo GIF",
     [PY, "reproducibility/terminal_demo_gif.py"], None),
    ("launch: Step 291 editor/LSP inline diagnostics demo GIF",
     [PY, "reproducibility/editor_lsp_demo_gif.py"], None),
