...
One command — `docker run --rm tensorguard-capsule` — regenerates **76** deterministic artifacts from source and verifies each is byte-identical to the committed tree, then re-audits every README numeric claim.
