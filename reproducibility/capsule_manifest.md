...
One command — `docker run --rm tensorguard-capsule` — regenerates **80** deterministic artifacts from source and verifies each is byte-identical to the committed tree, then re-audits every README numeric claim.
