...
corpus, **15** fire through a handler chain
...
| `transformers__AlbertForMaskedLM__444a57ae` | transformers | 104 | lean_or_pp_only | argmax,cross_entropy,embed,linear,view,where |
| `transformers__AlbertForPreTraining__0bc1b159` | transformers | 106 | lean_or_pp_only | cross_entropy,embed,linear,unsqueeze,view |
| `transformers__BartDecoderWrapper__145bd043` | transformers | 12 | no_handlers_detected |  |
| `transformers__BartForSequenceClassification__7b1a4896` | transformers | 149 | uncovered_only | cross_entropy,squeeze,sum,to,view |
| `transformers__BartModel__27886110` | transformers | 158 | uncovered_only | sqrt |
| `transformers__BertForMaskedLM__f07c0986` | transformers | 107 | lean_or_pp_only | cat,cross_entropy,view |
| `transformers__BertForNextSentencePrediction__ddcf8ce2` | transformers | 98 | lean_or_pp_only | cross_entropy,view |
| `transformers__BertForPreTraining__fb4fc487` | transformers | 103 | lean_or_pp_only | cross_entropy,view |
...
| `transformers__DebertaForSequenceClassification__f3f064d8` | transformers | 110 | uncovered_only | cross_entropy,dropout,expand,gather,linear,mean,squeeze,sum,to,view |
| `transformers__DebertaModel__d4dcd33c` | transformers | 105 | no_handlers_detected |  |
| `transformers__DistilBertFlashAttention2__9971185e` | transformers | 99 | lean_or_pp_only | reshape,to,view |
| `transformers__DistilBertModel__e1631f00` | transformers | 140 | lean_or_pp_only | embed,to |
| `transformers__ElectraForPreTraining__74bdacae` | transformers | 99 | lean_or_pp_only | squeeze,view |
| `transformers__FalconFlashAttention2__c64fa866` | transformers | 107 | lean_or_pp_only | reshape,to,transpose |
...
| `transformers__RobertaForCausalLM__bd93edfc` | transformers | 122 | lean_or_pp_only | to |
| `transformers__RobertaForMaskedLM__6e029774` | transformers | 91 | lean_or_pp_only | cross_entropy,to,view |
| `transformers__T5ForSequenceClassification__9276522e` | transformers | 166 | uncovered_only | cross_entropy,squeeze,sum,to,view |
