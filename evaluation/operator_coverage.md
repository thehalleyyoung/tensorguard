...
| **total** | 1031 | 199 | 0.193 |

Covered operators per namespace:

* `torch`: abs, acos, add, all, amax, amin, any, argsort, asin, atan, bernoulli, bmm, broadcast_to, cat, cdist, ceil, celu, chunk, clamp, clip, cos, cosh, cross, detach, div, divide, einsum, eq, equal, erf, erfc, exp, flatten, floor, gather, ge, gt, hardshrink, index_select, isfinite, isinf, isnan, kron, le, log, log10, log2, log_softmax, logsumexp, lt, masked_fill, masked_select, matmul, max, mean, min, mm, mul, multinomial, multiply, mv, nan_to_num, narrow, ne, neg, norm, outer, permute, poisson, prelu, prod, qr, relu, reshape, round, rrelu, rsqrt, scatter, scatter_add, select, selu, sigmoid, sign, sin, sinh, softmax, solve, sort, split, sqrt, squeeze, stack, std, sub, subtract, sum, svd, t, take, tan, tanh, tensordot, topk, transpose, true_divide, unique, unsqueeze, var
