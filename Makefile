...
help:
	...
	@echo "  release-readiness Regenerate Step 286 PyPI/conda/Docker release gate"
	...
	@echo "  editor-lsp-demo-gif Regenerate Step 291 editor/LSP inline diagnostics demo GIF"
...
negative-controls:
	$(PYTHON) evaluation/negative_controls.py
	$(PYTHON) evaluation/negative_controls.py --check
...
release-readiness:
	$(PYTHON) reproducibility/release_readiness.py
	$(PYTHON) reproducibility/release_readiness.py --check

contributor-onboarding:
	$(PYTHON) reproducibility/contributor_onboarding.py
	$(PYTHON) reproducibility/contributor_onboarding.py --check

launch-campaign:
	$(PYTHON) reproducibility/launch_campaign.py
	$(PYTHON) reproducibility/launch_campaign.py --check
...
editor-lsp-demo-gif:
	$(PYTHON) reproducibility/editor_lsp_demo_gif.py
	$(PYTHON) reproducibility/editor_lsp_demo_gif.py --check

camera-ready-paper:
	$(PYTHON) reproducibility/camera_ready_paper.py

governance-acceptance:
	$(PYTHON) reproducibility/governance_acceptance.py
	$(PYTHON) reproducibility/camera_ready_paper.py --check

paper-results-freshness:
	$(PYTHON) reproducibility/paper_results_freshness.py --refresh --write

playground:
	$(PYTHON) -m src.cli.main playground --output tensorguard_playground
...
sarif-trends:
	...
	$(PYTHON) evaluation/sarif_trends.py --check
