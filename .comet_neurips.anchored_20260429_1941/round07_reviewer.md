...
1. **The 488-block headline regressed on the load-bearing measured-RP claim from round 5.** The round-5 paper cited 14/488 unconditional RP under a "user-visible default with input-shape contract + unbind handler" regime, with `timm::Channe...
2. **The `ag_composition_ext` mechanisation footprint is unchanged and still does not cover the operators that fire on the empirical headline.** The 5/5 round-6 unfiltered-post-freeze catches all touch a Lean-audited shape-transfer rule (li...
3. **The §4.4 105/185 split was promoted to 103/185 in round 5 and is now back to 105/185 in round 6**, with Table 7 reverted to "28 Lean-audited | 3 pen-and-paper | 48 tested-only" (vs. round 5's 28/7/44). Either re-instate the four trivia...
4. **The 488-block denominator question is still unaddressed.** The round-5 unbind-rerun artefact reclassified 199/488 corpus rows as "Abstain / not-analysable" because the block-extractor strips surrounding class context and the analyser e...
5. **Theorem 5's empirical surface still has no measured cardinality on non-INT falsifier events.** The 55-module larger-population audit reports 0 SHAPE/DTYPE/RANK guards (denominator 0 on the falsifiable predicate), the 14-module / CNN-on...
6. **The 365-Verified tied-weight subset is still bounded only by abstention rather than by direct measurement.** The 8-HF-model runtime-trainer harness added in §6 is a meaningful runtime closure on a related family but does not stub-mock-...
