...
● list paper artifacts (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && ls -la neurips.pdf neurips.tex 2>&1 | head; ls docs/paper/sections_v5/
  │ 2>&1 | head -40
  └ 34 lines...

● read abstract (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && grep -A30 "begin{abstract}" neurips.tex | head -50
  └ 32 lines...

● rest of abstract (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && grep -A40 "begin{abstract}" neurips.tex | tail -25
  └ 25 lines...

● section sizes (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && wc -l docs/paper/sections_v5/*.tex; ls .comet_neurips/ 2>&1 | head -20
  └ 51 lines...
...
● Read H_related_work.tex
  │ docs/paper/sections_v5/H_related_work.tex
  └ 153 lines read
...
● check CEGAR + previous round (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && grep -n "CEGAR\|metadata only" experiments_v5/feature_ablation.json 2>&1
  │ | head -20; ls .comet_neurips/round03* 2>&1
  └ 10 lines...

● check rebuttal anchors (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && grep -n "qkv\|gradient_checkpointing_enable\|tied_weight"
  │ experiments_v5/*.json experiments_v5/*.jsonl 2>&1 | head -10; grep -rn
  │ "transformers sweep\|6/6 Verified\|GRADIENT-OUT-OF-FRAGMENT"
  │ docs/paper/sections_v5/*.tex 2>&1 | head -20
  └ 13 lines...

● Read eval_v6.tex
  │ docs/paper/sections_v5/eval_v6.tex
  └ L1670:1745 (76 lines read)

● check 57/185 discussion (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && grep -n "57/185\|57\/185\|outside.*soundness\|outside any\|tested-only"
  │ docs/paper/sections_v5/eval_v6.tex 2>&1 | head -15
  └ 16 lines...

● Read eval_v6.tex
  │ docs/paper/sections_v5/eval_v6.tex
  └ L1490:1620 (131 lines read)

● Read round03_reviewer.out.md
  │ .comet_neurips/round03_reviewer.out.md
  └ L1:40 (40 lines read)
