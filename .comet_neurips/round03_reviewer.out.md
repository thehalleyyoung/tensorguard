...
● Extract paper text (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && pdftotext neurips.pdf - 2>/dev/null | head -300
  └ 301 lines...
...
● Check previous experiments (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && ls .comet_neurips/ 2>/dev/null && cat
  │ .comet_neurips/round02_experiments.md 2>/dev/null | head -100
  └ 109 lines...

● Read more of paper (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && pdftotext neurips.pdf - 2>/dev/null | sed -n '300,600p'
  └ 302 lines...

● Check injected bugs summary and DL4C results (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && cat benchmarks/injected_bugs.json | python3 -c "import json,sys;
  │ d=json.load(sys.stdin); s=d.get('summary',{});
  │ print(json.dumps(s,indent=2))" && echo "---" && cat
  │ benchmarks/dl4c_bench_results.json | python3 -m json.tool | head -60
  └ 85 lines...

● Check for real source results (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && ls benchmarks/ && cat benchmarks/real_source_results.json 2>/dev/null |
  │ python3 -m json.tool | head -50 || echo "not found"
  └ 25 lines...

● Check pre-registered sample stats in paper (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && pdftotext neurips.pdf - 2>/dev/null | grep -n
  │ "5/15\|pre-register\|post-freeze\|unfiltered\|488\|Wilson\|15/\|15 " | head
  │ -30
  └ 31 lines...

● Check real bug corpus details (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
...
● Run revision verification script (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && python3 verify_neurips_revision.py 2>&1 | tail -40
  └ 33 lines...

● Check feature ablation data (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && cat experiments_v5/feature_ablation.json 2>/dev/null | python3 -m
  │ json.tool | head -60
  └ 61 lines...

● Read paper evaluation section (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && pdftotext neurips.pdf - 2>/dev/null | sed -n '1100,1400p'
  └ 302 lines...

● Read real-source and unfiltered corpus section (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && pdftotext neurips.pdf - 2>/dev/null | sed -n '1390,1560p'
  └ 172 lines...

● Find pre-registered sample discussion (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && pdftotext neurips.pdf - 2>/dev/null | grep -n "5/15\|15-bug
  │ post-freeze\|15-bug unfiltered\|pre-freeze\|registered" | head -20
  └ 16 lines...

Now I have enough to write the comprehensive review.

● Check real benchmark results (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && cat benchmarks/real_benchmark_results.json 2>/dev/null | python3 -m
  │ json.tool | head -40
  └ 41 lines...

● Check API feature status in paper (shell)
  │ cd /Users/halleyyoung/Documents/div/mathdivergence/halley-labs/tensorguard
  │ && pdftotext neurips.pdf - 2>/dev/null | grep -n
  │ "check_devices\|check_phases\|check_gradients\|API" | head -20
  └ 4 lines...
