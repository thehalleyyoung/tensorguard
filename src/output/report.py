...
class LSPDiagnosticGenerator:
    ...
    def __init__(self, source_name: str = "tensorguard") -> None:
        ...
        for f in report.findings:
            ...
            if rid not in seen:
                seen[rid] = {
                    ...
                    "helpUri": f"https://tensorguard.dev/rules/{f.category.value}",
                }
            ...
            "runs": [{
                "tool": {
                    "driver": {
                        ...
                        "informationUri": "https://tensorguard.dev",
                        "rules": rules,
                    }
                },
                "results": results,
